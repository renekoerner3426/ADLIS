...
public class ADLRecorderApplication {
	...
	private static void postADLRecord() {
	 	List<String> fins = new ArrayList<>(Arrays.asList("WVWZZZ1KZDP045466", "WVWABC1JZ3W324523", "WVWZKL5TG0W365465", "WVWSDF1CP3W456646",
		 ...
		 for (String fin : fins) {
			try {
				...
				URI POST_URL = new URI("http://adlbackendservice:8081/adl-api/v1/saveADL");
