	...
	private static void postADLRecord() {
		 ...
		 for (String fin : fins) {
			try {
				...
				URI POST_URL = new URI("http://adlbackend-service:8081/adl-api/v1/saveADL");
				...
				HttpEntity<ADLRecord> adlRecord = new HttpEntity<>(new ADLRecordGenerator().generateADLRecord("AAAAAAAAAAAAAA"), headers);
